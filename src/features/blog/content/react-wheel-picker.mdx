...
image: /images/blog/react-wheel-picker.webp
...
<ComponentPreview
  ...
  openInV0Url="https://kyuu/r/wheel-picker.json"
/>

## About

The Wheel Picker component is built on top of [React Wheel Picker](https://react-wheel-picker.kyuu).
...
```bash
npx shadcn@latest add https://kyuu/r/wheel-picker.json
```
