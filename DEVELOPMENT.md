...
```bash
git clone https://github.com/yuuslokrobjakkroval/kyuu-portfolio.git yourname-portfolio
...
```bash
npx shadcn@latest add https://kyuu/r/cn.json
npx shadcn@latest add https://kyuu/r/theme-switcher.json
npx shadcn@latest add https://kyuu/r/flip-sentences.json
npx shadcn@latest add https://kyuu/r/apple-hello-effect.json
```
